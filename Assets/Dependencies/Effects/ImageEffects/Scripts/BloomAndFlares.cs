...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class BloomAndFlares : PostEffectsBase {
        ...
        public override bool CheckResources() {
            ...
            addBrightStuffBlendOneOneMaterial = CheckShaderAndCreateMaterial(addBrightStuffOneOneShader,
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            var secondQuarterRezColor = RenderTexture.GetTemporary(source.width / 4, source.height / 4, 0,
                rtFormat);
            var thirdQuarterRezColor = RenderTexture.GetTemporary(source.width / 4, source.height / 4, 0,
                rtFormat);
