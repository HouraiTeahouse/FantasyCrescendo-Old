...
namespace HouraiTeahouse {
    ...
    public abstract class AbstractFactoryEventBehaviour<T, TEvent> : EventBehaviour<TEvent> where T : Object {
        ...
        protected virtual bool ShouldCreate(TEvent eventArgs) { return eventArgs != null; }
