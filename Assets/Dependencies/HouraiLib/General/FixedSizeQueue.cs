...
namespace HouraiTeahouse {
    ...
    /// <summary> 
    /// A fixed size FIFO (First In First Out) Queue. Will dequeue elements until within a defined limit. 
    /// </summary>
    ...
    public class FixedSizeQueue<T> : IEnumerable<T> {
        ...
        /// </summary>
        /// <remarks> 
        /// If the enumerable is empty or null, the resultant instance will be empty. Elements will be added in order
        /// they are enumerated from the object's enumerator. 
        /// </remarks>
        /// <param name="size"> the limit on the size of the instance </param>
