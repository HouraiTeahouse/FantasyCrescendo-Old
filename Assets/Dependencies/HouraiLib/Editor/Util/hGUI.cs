...
namespace HouraiTeahouse.Editor {
    ...
    public static class HGUI {
        ...
        public static bool ToolbarButton(string content, params GUILayoutOption[] options) {
        ...
        public static bool ToolbarToggle(GUIContent content, bool value, params GUILayoutOption[] options) {
            return GUILayout.Toggle(value, content, EditorStyles.toolbarButton, options);
        }

        public static bool ToolbarToggle(string content, bool value, params GUILayoutOption[] options) {
            return GUILayout.Toggle(value, content, EditorStyles.toolbarButton, options);
        }
        ...
        public static IDisposable Property(GUIContent label, Rect position, SerializedProperty property) {
            return new PropertyDisposable(label, position, property);
        }

        public static IDisposable Enabled(bool state) { return new EnabledDisposable(state); }
