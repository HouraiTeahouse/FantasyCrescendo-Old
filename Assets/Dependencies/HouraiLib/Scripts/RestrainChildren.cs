...
namespace HouraiTeahouse {
    ...
    /// <summary> 
    /// A MonoBehaviour that restricts the posiiton of all of the children of the GameObject it is attached to. 
    /// </summary>
    public class RestrainChildren : MonoBehaviour {

        [SerializeField]
        [Tooltip("In local coordiates, the bounds for where the children of the GameObject can move.")]
        Bounds _bounds;
