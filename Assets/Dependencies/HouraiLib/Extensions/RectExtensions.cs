...
namespace HouraiTeahouse {
    ...
    public static class RectExtensions {
        ...
        ///     If the height of the Rect is zero, returns NaN.
        /// </summary>
        ...
        /// <summary>
        ///     Restricts a Rect to to a certain size. Retains the center.
        ///     Optionally can enforce an aspect ratio.
        /// </summary>
        /// <param name="rect">the source Rect</param>
        /// >
        ...
        public static Rect Restrict(this Rect rect, float width, float height, float? aspect = null) {
            ...
            if (aspect == null) {
                ...
                var enclosingAspectRatio = width / height;
                var aspectRatio = aspect.Value;
