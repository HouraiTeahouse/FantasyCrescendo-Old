...
namespace HouraiTeahouse {
    /// <summary>
    ///     A PropertyAttribute for the Unity Editor. Marks a string field to store a path to an asset stored in a Resources
    ///     folder.
    ...
    public class ResourceAttribute : PropertyAttribute {
        ...
        /// </summary>
        /// <param name="type">
        ///     Optional type restriction on the type of Resource object to use. No restriction is applied if null
        ///     or not derived from UnityEngine.Object
        /// </param>
