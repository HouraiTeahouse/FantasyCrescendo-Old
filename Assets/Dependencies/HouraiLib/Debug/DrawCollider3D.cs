...
namespace HouraiTeahouse {
    ...
    public class DrawCollider3D : MonoBehaviour {
        ...
        [SerializeField, Tooltip("Whether or not to include the Colliders in the children of the GameObject or not.")] private bool includeChildren;

        [SerializeField, Tooltip("If set to true, colliders are drawn as solids, otherwise drawn as wireframes.")] private bool solid;
