...
namespace HouraiTeahouse.SmashBrew {
    ...
    public partial class Character : HouraiBehaviour, IDamageable, IHealable, IKnockbackable {
        ...
        [SerializeField] private readonly float _fastFallSpeed = 9f;

        [SerializeField] private readonly float _maxFallSpeed = 5f;

        [SerializeField] private readonly float[] _jumpPower = {1.5f, 1.5f};
        ...
        protected virtual void OnCollisionEnter(Collision col) {
            ...
            var r2 = MovementCollider.radius * MovementCollider.radius;
            var bottom = transform.TransformPoint(MovementCollider.center - Vector3.up * MovementCollider.height / 2);
        ...
        protected virtual void Reset() {
            ...
            foreach (var component in GetRequiredComponents())
