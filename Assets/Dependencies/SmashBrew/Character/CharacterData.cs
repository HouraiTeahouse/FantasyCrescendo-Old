...
namespace HouraiTeahouse.SmashBrew {
    ...
    public class CharacterData : ScriptableObject {
        ...
        [Header("General Data")] [SerializeField] private readonly TouhouGame _sourceGame = TouhouGame.Other;

        [SerializeField] private readonly TouhouStage _sourceStage = TouhouStage.Other;
        ...
        ///     thrown if <paramref name="pallete" /> is less than 0 or greater than
        ///     <see cref="PalleteCount" />
        /// </exception>
        /// <returns></returns>
        ...
        private void RegeneratePortraits() {
