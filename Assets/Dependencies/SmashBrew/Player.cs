...
namespace HouraiTeahouse.SmashBrew {
    public sealed class Player {
        ...
        public int Pallete {
            ...
            set {
                ...
                if (SelectedCharacter) {
                    var count = SelectedCharacter.PalleteCount;
                    if (count > 0)
        ...
        ///         than or equal to the maximum number of players
        ///     </param>
        /// </exception>
        ...
        internal Character Spawn(Vector3 pos, bool direction) {
            ...
            var prefab = SpawnedCharacter.Prefab.Load();
            if (prefab == null)
                return null;
        ...
        public static bool operator ==(Player p1, Player p2) {
            var nullCheck1 = ReferenceEquals(p1, null);
            var nullCheck2 = ReferenceEquals(p2, null);
