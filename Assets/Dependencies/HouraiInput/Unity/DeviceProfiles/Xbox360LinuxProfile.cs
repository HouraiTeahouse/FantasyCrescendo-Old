namespace HouraiTeahouse.HouraiInput {
    ...
    public class Xbox360LinuxProfile : UnityInputDeviceProfile {
        ...
        public Xbox360LinuxProfile() {
            ...
            JoystickNames = new[] {"Microsoft X-Box 360 pad", "Generic X-Box pad"};
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "DPad Left", Target = InputTarget.DPadLeft, Source = Button(11), Invert = true},
                new InputMapping {Handle = "DPad Right", Target = InputTarget.DPadRight, Source = Button(12)},
                new InputMapping {Handle = "DPad Up", Target = InputTarget.DPadUp, Source = Button(13), Invert = true},
                ...
                new InputMapping {Handle = "Menu", Target = InputTarget.Menu, Source = Button(8)}
            };
