namespace HouraiTeahouse.HouraiInput {
    ...
    public class NatecGenesisP44Profile : UnityInputDeviceProfile {
        ...
        public NatecGenesisP44Profile() {
            ...
            JoystickNames = new[] {"EX10 GAMEPAD"};
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "L", Target = InputTarget.LeftBumper, Source = Button(4)},
                new InputMapping {Handle = "R", Target = InputTarget.RightBumper, Source = Button(5)},
                new InputMapping {Handle = "LL", Target = InputTarget.LeftTrigger, Source = Button(6)},
                new InputMapping {Handle = "RR", Target = InputTarget.RightTrigger, Source = Button(7)},
                ...
                new InputMapping {Handle = "Menu", Target = InputTarget.Menu, Source = Button(12)}
            };
