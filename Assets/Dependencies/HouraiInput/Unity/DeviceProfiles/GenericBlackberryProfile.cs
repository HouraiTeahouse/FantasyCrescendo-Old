namespace HouraiTeahouse.HouraiInput {
    ...
    public class GenericBlackBerryProfile : UnityInputDeviceProfile {
        ...
        public GenericBlackBerryProfile() {
            ...
            SupportedPlatforms = new[] {"Blackberry",};

            JoystickNames = new[] {"BlackBerry Gamepad :: SteelSeries FREE"};
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "Back", Target = InputTarget.Select, Source = Button(6)},
