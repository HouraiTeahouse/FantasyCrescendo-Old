    ...
    public class XboxOneMacProfile : UnityInputDeviceProfile {
        ...
        public XboxOneMacProfile() {
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "View", Target = InputTarget.View, Source = Button(10)},
                new InputMapping {Handle = "Menu", Target = InputTarget.Menu, Source = Button(9)},
                new InputMapping {Handle = "Guide", Target = InputTarget.System, Source = Button(15)}
            };
