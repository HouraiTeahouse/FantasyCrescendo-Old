namespace HouraiTeahouse.HouraiInput {
    ...
    public class XboxOneWinProfile : UnityInputDeviceProfile {
        ...
        public XboxOneWinProfile() {
            ...
            JoystickNames = new[] {"Controller (XBOX One For Windows)"};
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "View", Target = InputTarget.View, Source = Button(6)},
                new InputMapping {Handle = "Menu", Target = InputTarget.Start, Source = Button(7)}
            };
