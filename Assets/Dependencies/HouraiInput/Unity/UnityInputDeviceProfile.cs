        ...
        public bool IsJoystick {
            get {
                return (LastResortRegex != null) || 
                    !(JoystickNames == null || !JoystickNames.Any()) || 
                    !(JoystickRegex == null || !JoystickRegex.Any());
            }
        }

        public bool IsHidden { get { return HiddenTypes.Contains(GetType());} }
        public virtual bool IsKnown { get { return true; } }
        public int AnalogCount { get { return AnalogMappings.Length; } }
        public int ButtonCount { get { return ButtonMappings.Length; } }
