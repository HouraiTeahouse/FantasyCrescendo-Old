...
namespace HouraiTeahouse.HouraiInput {
    public class InputDevice {
        ...
        public InputDevice(string name) {
            ...
            var numInputControlTypes = Enum.GetValues(typeof (InputTarget)).Length;
        ...
        public InputControl GetControl(InputTarget inputTarget) {
            var control = Controls[(int) inputTarget];
        ...
        public InputControl GetControlByName(string inputControlName) {
            var inputType = GetInputControlTypeByName(inputControlName);
