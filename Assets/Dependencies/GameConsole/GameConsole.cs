...
namespace HouraiTeahouse.Console {
    ...
    public static class GameConsole {
        ...
        static FixedSizeQueue<string> _history;
        ...
        /// <summary> Registers a callback to a command that is executable in the GameConsole. </summary>
        /// <remarks> Multiple callbacks can be registered to the same command. All will be executed, in the order in which they
        /// were registered. </remarks>
        ...
        /// <summary> Unregisters a callback from a command. </summary>
        /// <remarks> If a command is registered multiple times, one call only removes one of it's instances. </remarks>
        /// <param name="command"> the command string to use </param>
        /// <param name="callback"> the handler that is to be registered </param>
        /// >
        ...
        /// <summary> Clears Console history. </summary>
        ...
        /// <summary> Logs a message to the GameConsole </summary>
        ...
        public static void Log(string message, params object[] objs) {
            _history.Enqueue(string.Format(message.EmptyIfNull(), objs));
            if (OnConsoleUpdate != null)
                OnConsoleUpdate();
        }
